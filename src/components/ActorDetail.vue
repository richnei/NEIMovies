...
<v-card :elevation="hover ? 16 : 2"
    ...
    >
      ...
      fas fa-globe-asia
            ...
            <v-col cols="12" sm="8">
                <h1 class="  black--text text--darken-3 mt-5">{{ this.actor.name }}</h1>
                <v-row>
                    <v-col cols="12">
                        <v-btn text >
      ...
      <p class="mt-5 black--text text--darken-3 subheader">{{ this.actor.biography }}</p>
      <h4 class="mt-1 black--text">Known For</h4>
      <v-row>
...
<v-card :elevation="hover ? 16 : 2"
        ...
        <h2 class="mt-2 black--text ">Credits</h2>
        <ul class=" pl-5 mt-8">
