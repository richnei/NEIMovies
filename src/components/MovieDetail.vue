          ...
          <v-img :src="posterPath" alt="" class=""/>
            ...
            <v-col cols="12" sm="8">
                ...
                <v-row>
                    ...
                    <v-col cols="12" sm="3">
                        <span class="black--text ml-n7">
                            {{movie.vote_average * 10}}% | {{movie.release_date}}
                        </span>
                    </v-col>
                    <v-col cols="12" sm="7">
                        <div class="subtitle-2 black--text ml-n16">
                ...
                <p class="mt-5 black--text text--darken-3 subheader">{{this.movie.overview}}</p>
                <div class="mt-5">
                    <h2 class="mt-5 black--text text--darken-3">Featured Cast</h2>
                    <div :key="index" v-for="(crew, index) in movie.credits.crew" class="mt-5">
                        <div v-if="index < 2" class="">
                            <h3>{{crew.name}}</h3>
                            <span class="black--text">{{crew.job}}</span>
                        </div>
                    </div>
                </div>
                <v-dialog
